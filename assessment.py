...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    """
def foods_in_common(foods1, foods2):
    foods1 = set(["cheese", "bagel", "cake", "kale"])
    foods2 = set(["hummus", "beets", "bagel", "lentils", "kale"])
    sets = foods1 & foods2
    return sets
...
def largest_n_items(items, n):
    ...
    separately::
        ...
        [3, 3]
    """
# I'm not sure I understand this question. I tried to tackle at least to return the list
# in ascending order.
# largest_n_items = [2, 6006, 700, 42, 6, 59]
# new_largest_n_items = sorted(largest_n_items)
# print new_largest_n_items
    # return []
