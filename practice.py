...
def long_words(words):
    ...
    """
    long_words_list = []
    for long_words in words:
        if len(long_words) > 4:
            long_words_list.append(long_words)
    return long_words_list

value = long_words_list(words)
print value
...
def smallest_int(numbers):
    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    for i in x:
        if i < x:
            x = i
    # not sure to use return or print
    print (x)
...
def largest_int(numbers):
    ...
    **DO NOT USE** the built-in function `max()`!
    ...
    If the input list is empty, return None::
        ...
        True
    """
    # why use [0], to indicat that you're starting from 0?
    numbers = largest_int[0]
    # is largest_number every number in our list?
    for largest_num in largest_int:
        # what is largest? every number in our list?
        if largest_num > largest_int:
            numbers = largest_num
    # print largest
    return numbers
...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    for i in range(len(halvesies) / 2):
        print numbers
...
def sum_numbers(numbers):
    ...
    Any empty list should return the sum of zero::
        ...
        0
    """
    # use range when using for loop and calculating sum.
    numbers = [1, 2, 3, 10]
    total = 0
    for i in numbers:
        total = total + i
...
def join_strings(words):
    ...
    For an empty list, you should return an empty string::
        ...
        ''
    """
for strings in range(len(join_strings)):
    print(join_strings[strings])
    # ERROR:'list' object has no attribute 'split'
    # can't split a list, don't know how to change list to string
    # to make it work??
...
def join_strings_with_comma(words):
    ...
    thing, of course::
        ...
        'Pretzel'
    """
",".join([str(item) for item in numbers])
    return numbers
